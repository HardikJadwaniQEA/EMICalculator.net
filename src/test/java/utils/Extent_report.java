...
public class Extent_report implements ITestListener
{
	...
	public void onStart(ITestContext testContext) 
	{
		...
		sparkReporter.config().setDocumentTitle("EMI Calculator header view report"); 
		sparkReporter.config().setReportName("EMICalculator Functional Testing"); 
		...
		extent.setSystemInfo("User Name", "Hardik Jadwani" );
